...
type Page =
  | "explore" | "cinema" | "audio" | "image" | "marketing"
  | "video" | "influencer" | "canvas" | "apps" | "library" | "login"
...
const CMODELS = [
  { name:"Cinema Studio 3.5", tag:"NEW",       desc:"AI director Â· camera selection Â· style presets", group:"Cinematic" },
  ...
  { name:"Seedance 2.0",      tag:"NEW",       desc:"720p Â· 4sâ€“15s Â· ByteDance",                      group:"Featured"  },
  { name:"Seedance 2.0 Fast", tag:"NEW",       desc:"720p Â· fast render",                             group:"Featured"  },
  { name:"Kling 3.0",         tag:"EXCLUSIVE", desc:"4K Â· 3sâ€“15s",                                    group:"Featured"  },
  { name:"Kling 3.0 MC",      tag:"",          desc:"1080p Â· motion control Â· 3sâ€“30s",                group:"Featured"  },
  { name:"HappyHorse",        tag:"NEW",       desc:"1080p Â· 3sâ€“15s",                                 group:"Featured"  },
];
...
const LSTEPS  = ["Analyzing promptâ€¦","Selecting modelâ€¦","Composing camera motionâ€¦","Rendering previewâ€¦"];
...
const APPS_D: Record<string,{name:string;desc:string;icon:string}[]> = {
  "Professional":       [{name:"Virality Predictor",desc:"Predict viral potential",icon:"ðŸ“Š"},{name:"Similarity Score",desc:"Visual likeness",icon:"ðŸ”"},{name:"Expand Image",desc:"AI outpainting",icon:"â†”"},{name:"Angles 2.0",desc:"Multi-angle shots",icon:"ðŸ“"},{name:"Shots",desc:"Cinematic composer",icon:"ðŸŽ¬"}],
  "Enhance & Style":    [{name:"Skin Enhancer",desc:"AI skin retouching",icon:"âœ¨"},{name:"AI Stylist",desc:"Fashion recommendations",icon:"ðŸ‘—"},{name:"Relight",desc:"Pro lighting adj.",icon:"ðŸ’¡"},{name:"Outfit Swap",desc:"Virtual outfit",icon:"ðŸ”„"},{name:"Style Snap",desc:"Snap & style",icon:"ðŸ“¸"}],
  "Face & Identity":    [{name:"Face Swap",desc:"Seamless face replace",icon:"ðŸŽ­"},{name:"Headshot Gen",desc:"Pro headshots",icon:"ðŸ–¼"},{name:"Character Swap",desc:"Full character replace",icon:"ðŸ”€"},{name:"Recast",desc:"Scene character swap",icon:"ðŸŽ¬"},{name:"Video Face Swap",desc:"Video face swap",icon:"ðŸ“¹"}],
  "Ads & Products":     [{name:"Click to Ad",desc:"URL to video ad",icon:"ðŸŽ¯"},{name:"Billboard Ad",desc:"Billboard creator",icon:"ðŸ™"},{name:"Bullet Time",desc:"Matrix bullet time",icon:"âš¡"},{name:"Truck Ad",desc:"Vehicle ad creator",icon:"ðŸš›"},{name:"UGC Factory",desc:"UGC content gen",icon:"ðŸ“±"}],
  "Games & Characters": [{name:"Game Dump",desc:"Game-style scenes",icon:"ðŸŽ®"},{name:"Nano Strike",desc:"Action sequences",icon:"âš”"},{name:"Nano Theft",desc:"Heist cinematic",icon:"ðŸŽ°"},{name:"Simlife",desc:"Life simulation",icon:"ðŸŒ"},{name:"Plushies",desc:"Cute characters",icon:"ðŸ§¸"}],
};
...
function Logo({sz=28}:{sz?:number}) {
  return (
    <div style={{display:"flex",alignItems:"center",gap:8}}>
      ...
      <span style={{color:T1,fontWeight:800,fontSize:sz*.5,letterSpacing:-.5}}>Lumen<span style={{color:M}}>field</span></span>
    </div>
  );
}
...
// â”€â”€â”€ EXPLORE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function ExplorePage({go}:{go:(p:Page)=>void}) {
  ...
  const cards = [
    {n:"Cinema Studio 3.5",d:"AI director Â· camera control",i:"ðŸŽ¥",p:"cinema" as Page,a:M},
    {n:"Seedance 2.0",     d:"720p cinematic video",        i:"âš¡",p:"cinema" as Page,a:"#6366f1"},
    {n:"Marketing Studio", d:"Product ads in seconds",      i:"ðŸ“±",p:"marketing" as Page,a:M},
    {n:"AI Influencer",    d:"Build virtual creators",      i:"ðŸ¤–",p:"influencer" as Page,a:"#10b981"},
    {n:"Nano Visual Pro",  d:"Photorealistic images",       i:"ðŸŽ¨",p:"image" as Page,a:"#f59e0b"},
    {n:"Audio Studio",     d:"Voices in 30+ languages",     i:"ðŸŽ™",p:"audio" as Page,a:"#06b6d4"},
    {n:"Canvas",           d:"AI visual workspace",         i:"ðŸ–¼",p:"canvas" as Page,a:"#8b5cf6"},
  ];
  return (
    <div style={{minHeight:"100vh",paddingTop:57,background:BG,overflowX:"hidden"}}>
      ...
      <section style={{position:"relative",padding:"100px 48px 80px",textAlign:"center",overflow:"hidden"}}>
        ...
        <div style={{position:"relative",zIndex:1}}>
          ...
          <div style={{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap"}}>
            <button className="bm" onClick={()=>go("cinema")} style={{padding:"14px 34px",fontSize:14,animation:"glow 3s ease-in-out infinite"}}>Launch Studio â†’</button>
      ...
      <section style={{padding:"0 48px 64px",maxWidth:1280,margin:"0 auto"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20}}>
          ...
          <button className="bg" onClick={()=>go("apps")} style={{padding:"5px 14px",fontSize:11}}>View all â†’</button>
        </div>
      ...
      <section style={{margin:"0 auto 80px",background:S1,border:`1px solid ${B1}`,borderRadius:16,padding:"52px",textAlign:"center",position:"relative",overflow:"hidden",maxWidth:1184}}>
        ...
        <button className="bm" onClick={()=>go("login")} style={{padding:"14px 36px",fontSize:14}}>Start for free â†’</button>
      </section>
    </div>
  );
}

// â”€â”€â”€ CINEMA STUDIO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function CinemaPage() {
  ...
  return (
    <div style={{display:"flex",height:"100vh",paddingTop:57,background:BG}}>
      ...
      <aside style={{width:200,flexShrink:0,borderRight:`1px solid ${B1}`,padding:"16px 10px",display:"flex",flexDirection:"column",gap:2,background:BG}}>
        ...
        <button style={{background:"none",border:`1px solid ${B2}`,borderRadius:7,color:T3,fontSize:10,padding:"7px 12px",cursor:"pointer"}}>ðŸ’Ž Pricing â€” 30% OFF</button>
      </aside>
      {/* Main */}
        ...
        <div style={{flex:1,background:BG,backgroundImage:`linear-gradient(${B1} 1px,transparent 1px),linear-gradient(90deg,${B1} 1px,transparent 1px)`,backgroundSize:"40px 40px",display:"flex",alignItems:"center",justifyContent:"center",padding:40,overflow:"auto"}}>
          {!loading&&results.length===0&&(
            <div style={{textAlign:"center"}} className="fu">
              ...
              <p style={{color:T3,fontSize:13,marginTop:16}}>Type a prompt below and click Generate â†’</p>
            </div>
          )}
          {loading&&(
              ...
              <div style={{marginBottom:24}}>
                {LSTEPS.map((s,i)=>(
                  <div key={s} style={{display:"flex",alignItems:"center",gap:10,justifyContent:"center",marginBottom:12,color:i<step?T2:B2,fontSize:13,transition:"color .3s"}}>
                    <div style={{width:18,height:18,borderRadius:"50%",border:`1.5px solid ${i<step?M:B2}`,background:i<step?M:"transparent",display:"flex",alignItems:"center",justifyContent:"center",fontSize:9,color:"#fff",transition:"all .3s",flexShrink:0}}>{i<step?"âœ“":""}</div>
                    {s}
                  </div>
                ))}
              </div>
            ...
            <div style={{display:"flex",gap:14,flexWrap:"wrap",justifyContent:"center"}} className="fi">
              {results.map((_,i)=>(
                ...
                >
                  ...
                  <button style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:38,height:38,borderRadius:"50%",background:"rgba(232,0,111,.8)",border:"none",color:"#fff",fontSize:13,cursor:"pointer"}}>â–¶</button>
                  <div style={{position:"absolute",bottom:10,left:12}}>
                    <div style={{color:T1,fontSize:10,fontWeight:700}}>{model}</div>
                    <div style={{color:T3,fontSize:9}}>{aspect} Â· {dur} Â· {res}</div>
                  </div>
          ...
          <div style={{display:"flex",gap:10,flexWrap:"wrap",alignItems:"flex-end"}}>
            <div style={{flex:1,minWidth:240}}>
              <textarea className="inp" value={prompt} onChange={e=>setPrompt(e.target.value)}
                placeholder="Describe your scene â€” a futuristic city at dusk, golden hour, slow dolly inâ€¦"
            ...
            <div style={{position:"relative"}}>
              ...
              >
                ...
                {model.length>20?model.slice(0,18)+"â€¦":model}
                <span style={{color:T3,fontSize:9}}>â–¾</span>
              </button>
              {mOpen&&(
...
function AudioPage() {
  ...
  const models = [
    {n:"Eleven v3",             d:"Expressive AI voice Â· emotion control"},
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column"}}>
        <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:BG,backgroundImage:`radial-gradient(ellipse 50% 40% at 50% 50%,rgba(232,0,111,.05),transparent)`,position:"relative",overflow:"hidden"}}>
          <div style={{position:"absolute",bottom:80,left:0,right:0,display:"flex",justifyContent:"center",gap:2,opacity:.04}}>
            {Array.from({length:100},(_,i)=><div key={i} style={{width:2,borderRadius:2,height:`${30+Math.sin(i*.35)*40+((i*17)%20)}px`,background:M}}/>)}
          </div>
          <div style={{textAlign:"center",zIndex:1}} className="fu">
            ...
            <p style={{color:T3,fontSize:13}}>Type your script Â· select a voice Â· generate</p>
          </div>
          {wf.length>0&&(
            <div className="fi" style={{marginTop:36,background:S1,border:`1px solid ${B1}`,borderRadius:12,padding:"16px 20px",display:"flex",gap:2,alignItems:"center",zIndex:1}}>
              <button style={{width:34,height:34,borderRadius:"50%",background:M,border:"none",color:"#fff",fontSize:13,cursor:"pointer",flexShrink:0,marginRight:10}}>â–¶</button>
              ...
              <span style={{color:T3,fontSize:10,marginLeft:10,flexShrink:0}}>0:0{Math.ceil(text.split(" ").length/2.5)} Â· {aModel}</span>
            </div>
          )}
        </div>
        <div style={{background:S1,borderTop:`1px solid ${B1}`,padding:"16px 20px",display:"flex",gap:14,alignItems:"flex-end",flexWrap:"wrap"}}>
          ...
          <div style={{flex:1,minWidth:200}}>
            <Lbl s="Script"/>
            <textarea className="inp" value={text} onChange={e=>setText(e.target.value)} placeholder="Type your narration or script hereâ€¦" rows={4} style={{resize:"none",marginTop:6,lineHeight:1.5}}/>
          </div>
          ...
          <button className="bm" onClick={gen} disabled={loading} style={{padding:"12px 28px",alignSelf:"flex-end"}}>{loading?"Generatingâ€¦":"Generate Voice"}</button>
        </div>
      </div>
    </div>
  );
...
// â”€â”€â”€ MARKETING STUDIO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function MarketingPage() {
  ...
  const pIcons: Record<string,string> = {TikTok:"ðŸŽµ",Instagram:"ðŸ“¸",YouTube:"â–¶ï¸",Facebook:"ðŸ‘¤"};
    ...
    <div style={{display:"flex",height:"100vh",paddingTop:57,background:BG}}>
      ...
      <div style={{flex:1,overflow:"auto"}}>
        ...
        <div style={{padding:"28px 40px 24px",borderBottom:`1px solid ${B1}`,position:"relative",overflow:"hidden"}}>
          ...
          <p style={{color:T3,fontSize:13,marginTop:6}}>Upload product Â· choose style Â· get 9:16 ads in seconds</p>
        ...
        <div style={{padding:"24px 40px",maxWidth:920}}>
          ...
          <div style={{marginBottom:18}}>
            <Lbl s="Product URL â€” auto-fills product info"/>
            ...
            {pName&&(
              <div style={{marginTop:6,padding:"6px 10px",background:`${M}10`,border:`1px solid ${M}30`,borderRadius:6,display:"flex",alignItems:"center",gap:6}}>
                <span style={{color:M,fontSize:11}}>âœ“</span>
          ...
          <div style={{marginBottom:16}}>
            ...
            <textarea className="inp" value={prompt} onChange={e=>setPrompt(e.target.value)} placeholder="Describe what happens in the adâ€¦" rows={3} style={{resize:"none",marginTop:6,lineHeight:1.5}}/>
          </div>
          {/* Controls */}
            ...
            <div style={{display:"flex",gap:8,marginTop:8,flexWrap:"wrap"}}>
              {PLATS.map(p=>(
                <button key={p} className={`pc${plats.includes(p)?" on":""}`} onClick={()=>togglePlat(p)}>
                  ...
                  {plats.includes(p)&&<span style={{color:M,fontSize:10}}>âœ“</span>}
                </button>
              ))}
            </div>
          </div>
          ...
          <div style={{display:"flex",gap:10,marginBottom:20,flexWrap:"wrap",alignItems:"stretch"}}>
            ...
            <button className="bm" onClick={gen} disabled={loading} style={{padding:"0 32px",minHeight:48,fontSize:13,animation:!loading&&results.length===0?"glow 2.5s ease-in-out infinite":"none"}}>
              {loading?"Generating Adâ€¦":"Generate Ad â†’"}
            </button>
          </div>
          ...
          {results.length>0&&(
            <div className="fi">
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
                <Lbl s={`${results.length} ads Â· ${plats.join(", ")}`}/>
              ...
              <div style={{display:"flex",gap:14,flexWrap:"wrap"}}>
                {results.map((_,i)=>(
                  ...
                  >
                    ...
                    <button style={{position:"absolute",top:"42%",left:"50%",transform:"translate(-50%,-50%)",width:38,height:38,borderRadius:"50%",background:"rgba(255,255,255,.2)",border:"none",color:"#fff",fontSize:14,cursor:"pointer"}}>â–¶</button>
                    ...
                    <div style={{position:"absolute",bottom:10,left:10}}>
                      ...
                      <div style={{color:"rgba(255,255,255,.5)",fontSize:9}}>{hook} Â· 9:16 Â· 15s</div>
                    </div>
                  </div>
                ))}
              </div>
...
// â”€â”€â”€ MCP & CLI â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function McpPage() {
  return (
    <div style={{minHeight:"100vh",paddingTop:57,background:BG}}>
      <div style={{padding:"80px 48px",maxWidth:900,margin:"0 auto"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))",gap:12}}>
          {[{i:"âš¡",t:"Fast API",d:"Sub-second response times"},{i:"ðŸ”§",t:"Full SDK",d:"TypeScript & Python"},{i:"ðŸ”„",t:"Webhooks",d:"Real-time job updates"},{i:"ðŸ“¦",t:"Batch Jobs",d:"Process thousands at once"},{i:"ðŸ”",t:"Secure",d:"API key authentication"},{i:"ðŸ“Š",t:"Analytics",d:"Usage & cost tracking"}].map(f=>(
        ...
        <div style={{marginTop:32,display:"flex",gap:12}}>
          <button className="bm" style={{padding:"12px 28px"}}>Get API Key â†’</button>
...
// â”€â”€â”€ COLLAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function CollabPage() {
  return (
    <div style={{minHeight:"100vh",paddingTop:57,background:BG}}>
      <div style={{padding:"80px 48px",maxWidth:900,margin:"0 auto",textAlign:"center"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))",gap:12,maxWidth:700,margin:"0 auto 40px",textAlign:"left"}}>
          {[{i:"ðŸ‘¥",t:"Team Workspace",d:"Shared projects & assets"},{i:"ðŸ’¬",t:"Comments",d:"Leave feedback on any frame"},{i:"ðŸ”—",t:"Share Links",d:"One-click shareable URLs"},{i:"ðŸ“‹",t:"Review Mode",d:"Approve or request changes"},{i:"ðŸ·",t:"Version History",d:"Track every iteration"},{i:"ðŸ””",t:"Notifications",d:"Stay in the loop"}].map(f=>(
            <div key={f.t} className="card" style={{padding:"18px 16px"}}>
        ...
        <button className="bm" style={{padding:"13px 32px",fontSize:14}}>Invite Team â†’</button>
      </div>
    </div>
  );
}

// â”€â”€â”€ SUPERCOMPUTER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function SuperPage() {
  const [prompt,setPrompt] = useState("");
  const [loading,setLoading] = useState(false);
  ...
  const run = async () => {
    ...
    setLoading(false);
    setResult("âœ“ Task queued Â· Cinema Studio Â· Marketing Studio Â· Audio Studio Â· 3 agents activated");
  };
  return (
    <div style={{minHeight:"100vh",paddingTop:57,background:BG}}>
      <div style={{background:"linear-gradient(160deg,rgba(204,255,0,.04),transparent)",borderBottom:`1px solid ${B1}`,padding:"60px 48px",textAlign:"center"}}>
        <div style={{display:"inline-block",background:"rgba(204,255,0,.1)",border:"1px solid rgba(204,255,0,.3)",borderRadius:20,padding:"4px 14px",fontSize:11,color:"#ccff00",marginBottom:20,fontWeight:700,letterSpacing:.5}}>âš¡ NEW</div>
        ...
        <div style={{maxWidth:640,margin:"0 auto"}}>
          <textarea className="inp" value={prompt} onChange={e=>setPrompt(e.target.value)} placeholder="Create a TikTok ad for my fitness product with an AI influencerâ€¦" rows={3} style={{resize:"none",lineHeight:1.5,marginBottom:12,fontSize:14,border:"1px solid rgba(204,255,0,.2)"}}/>
          ...
          <button onClick={run} disabled={loading} style={{background:"#ccff00",color:"#000",border:"none",borderRadius:10,padding:"13px 40px",fontSize:14,fontWeight:900,cursor:loading?"not-allowed":"pointer",opacity:loading?.6:1,transition:"all .2s"}}>
            {loading?"Processingâ€¦":"Run Supercomputer â†’"}
          </button>
    ...
    <div style={{minHeight:"100vh",paddingTop:57,background:BG}}>
      <div style={{padding:"60px 48px 40px",borderBottom:`1px solid ${B1}`,position:"relative",overflow:"hidden"}}>
        ...
        <div style={{display:"flex",gap:10,marginTop:24,flexWrap:"wrap"}}>
          <button className="bm" style={{padding:"11px 24px"}}>â¬‡ Download for macOS</button>
          <button className="bg" style={{padding:"11px 24px"}}>â¬‡ Download for Windows</button>
        </div>
      </div>
      ...
      <div style={{padding:"40px 48px",maxWidth:1100,margin:"0 auto"}}>
        <div style={{marginBottom:40}}>
          <Lbl s="Setup â€” 3 steps"/>
          <div style={{display:"flex",gap:12,marginTop:16,flexWrap:"wrap"}}>
            {[{n:"1",t:"Download",d:"Get the .dmg or .exe installer"},{n:"2",t:"Install",d:"Follow the on-screen instructions"},{n:"3",t:`Open ${active}`,d:"Find Lumenfield under Window â†’ Extensions"}].map(s=>(
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(180px,1fr))",gap:10,marginTop:16}}>
            {features.map(f=>(
              <div key={f} className="card" style={{padding:"16px",display:"flex",alignItems:"center",gap:10}}>
                <span style={{color:M,fontSize:14}}>âœ“</span>
...
// â”€â”€â”€ AI INFLUENCER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function InfluencerPage() {
  ...
  const renderGrid = (label:string, field:string, opts:string[]) => (
    <div style={{marginBottom:18}}>
    ...
    <div style={{display:"flex",height:"100vh",paddingTop:57,background:BG}}>
      ...
      <div style={{width:268,flexShrink:0,borderRight:`1px solid ${B1}`,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:20,background:`radial-gradient(ellipse at center,${M}04,transparent)`}}>
        <div style={{width:196,height:256,borderRadius:16,background:done?`linear-gradient(160deg,#0d0019,#1a003a)`:S1,border:`1px solid ${done?M:B1}`,display:"flex",alignItems:"center",justifyContent:"center",position:"relative",overflow:"hidden",transition:"all .4s"}}>
          {loading&&<div style={{textAlign:"center"}}><div style={{width:28,height:28,border:`2px solid ${M}`,borderTopColor:"transparent",borderRadius:"50%",animation:"spin 1s linear infinite",margin:"0 auto 8px"}}/><div style={{color:T3,fontSize:11}}>Generatingâ€¦</div></div>}
          {done&&!loading&&<><div style={{width:72,height:92,borderRadius:36,background:`linear-gradient(160deg,${M},${ML})`,position:"absolute",top:"18%"}}/><div style={{position:"absolute",bottom:0,left:0,right:0,height:"40%",background:"linear-gradient(to top,#0d0019,transparent)"}}/><div style={{position:"absolute",bottom:14,color:T1,fontSize:11,textAlign:"center"}}><div style={{fontWeight:700}}>Lumenfield Character</div><div style={{color:T3,fontSize:9}}>{sel.char} Â· {sel.gender}</div></div></>}
          {!done&&!loading&&<div style={{color:T3,fontSize:11,textAlign:"center"}}>Preview<br/>appears here</div>}
        </div>
        <button className="bm" onClick={gen} disabled={loading} style={{marginTop:16,width:"100%",padding:"11px",animation:!loading&&!done?"glow 2.5s ease-in-out infinite":"none"}}>{loading?"Generatingâ€¦":done?"Regenerate â†’":"Generate Influencer â†’"}</button>
      </div>
      <div style={{flex:1,overflow:"auto",padding:"24px 28px"}}>
        <h2 style={{color:T1,fontSize:15,fontWeight:800,marginBottom:20,letterSpacing:-.3}}>Build Your AI Influencer</h2>
        {renderGrid("Character Type", "char", CHAR_T)}
        {renderGrid("Gender", "gender", GENS)}
        {renderGrid("Ethnicity", "eth", ETHS)}
        {renderGrid("Skin Color", "skin", SKINS)}
        {renderGrid("Eye Color", "eyes", EYES)}
        {renderGrid("Age", "age", ["Adult","Mature","Senior"])}
      </div>
    </div>
  );
}
...
function CanvasPage() {
  ...
  return (
    <div style={{height:"100vh",paddingTop:57,background:"#020202",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{position:"absolute",top:"18%",right:"22%",background:"#fff",color:"#111",borderRadius:10,padding:"6px 12px",fontSize:12,fontWeight:600,boxShadow:"0 4px 20px rgba(0,0,0,.5)"}}>That&apos;s stunning! ðŸŽ‰</div>
      <div style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",textAlign:"center",zIndex:10}}>
        ...
        {!created?(
          ...
          <div style={{color:M,fontSize:14,fontWeight:700}}>âœ“ Canvas created!</div>
        )}
      </div>
    ...
    <div style={{minHeight:"100vh",paddingTop:57,background:BG,padding:"72px 40px 40px"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:22,flexWrap:"wrap",gap:10}}>
        ...
        <div style={{display:"flex",gap:6}}>
          {(["grid","list"] as const).map(v=><button key={v} onClick={()=>setView(v)} style={{background:view===v?S2:"transparent",border:`1px solid ${B1}`,color:view===v?T1:T3,borderRadius:6,padding:"6px 12px",fontSize:11,cursor:"pointer"}}>{v==="grid"?"âŠž":"â‰¡"} {v}</button>)}
        </div>
      </div>
      ...
      <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"80px 0",textAlign:"center"}}>
        <div style={{fontSize:48,opacity:.1,marginBottom:16}}>ðŸŽ¬</div>
        <div style={{color:T2,fontSize:16,fontWeight:700,marginBottom:6}}>Your creations will appear here.</div>
        <div style={{color:T3,fontSize:13,marginBottom:28}}>Let&apos;s make magic âœ¨</div>
        <button className="bm" onClick={()=>go("cinema")} style={{padding:"12px 28px"}}>Start Generating â†’</button>
      </div>
    </div>
  );
}
    ...
    <div style={{display:"flex",height:"100vh",paddingTop:57,background:BG}}>
      <div style={{width:"42%",minWidth:340,flexShrink:0,display:"flex",flexDirection:"column",justifyContent:"center",padding:"40px 56px",borderRight:`1px solid ${B1}`}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:9}}>
          {[{icon:"G",label:"Continue with Google",bg:"#fff",fg:"#1a1a1a",border:"#e0e0e0"},{icon:"âŒ˜",label:"Continue with Apple",bg:"#111",fg:"#fff",border:B2},{icon:"M",label:"Continue with Microsoft",bg:"#0078d4",fg:"#fff",border:"#0078d4"},{icon:"âœ‰",label:"Continue with Email",bg:S1,fg:T2,border:B2}].map(b=>(
  ...
  return (
    <div style={{minHeight:"100vh",paddingTop:57,background:BG}}>
      <div style={{textAlign:"center",padding:"72px 48px 48px"}}>
        <div style={{display:"inline-block",background:`${M}15`,border:`1px solid ${M}40`,borderRadius:20,padding:"4px 14px",fontSize:11,color:ML,marginBottom:20,fontWeight:700,letterSpacing:.5}}>ðŸŽ‰ 30% OFF â€” Limited Time</div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:9,marginBottom:26}}>
              {plan.features.map(f=>(
                <div key={f} style={{display:"flex",gap:9,alignItems:"flex-start"}}>
                  <span style={{color:M,fontSize:11,marginTop:1,flexShrink:0}}>âœ“</span>
...
// â”€â”€â”€ IMAGE STUDIO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function ImagePage() {
  const [prompt,setPrompt] = useState("");
    ...
    <div style={{display:"flex",height:"100vh",paddingTop:57,background:BG}}>
      ...
      <div style={{flex:1,padding:"28px 36px",overflow:"auto"}}>
        ...
        <div style={{display:"flex",gap:10,marginBottom:14,flexWrap:"wrap",alignItems:"flex-end"}}>
          <div style={{flex:1,minWidth:240}}><textarea className="inp" value={prompt} onChange={e=>setPrompt(e.target.value)} placeholder="Describe the image you want to createâ€¦" rows={2} style={{resize:"none"}}/></div>
          <Sel label="Model" opts={IMG_M} val={model} set={setModel}/>
          <button className="bm" onClick={gen} disabled={loading} style={{padding:"10px 24px"}}>{loading?"Generatingâ€¦":"Generate"}</button>
        </div>
