...
export async function POST(req: Request) {
  try {
    ...
    const isVideo = !modelId?.includes("image") && !modelId?.includes("flux") && 
                    !modelId?.includes("gpt-image") && !modelId?.includes("nano") &&
                    !modelId?.includes("recraft") && !modelId?.includes("grok-image") &&
